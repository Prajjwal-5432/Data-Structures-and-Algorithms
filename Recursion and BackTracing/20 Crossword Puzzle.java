//Link: https://nados.io/question/crossword-puzzle?zen=true
import java.io.*;
import java.util.*;
...
class Main {
 ...
 public
  static boolean canPlaceVertical(char[][] arr, String word, int r, int c) {
    int i = 0;
    for (; i < word.length(); i++) {
      if (r + i >= arr.length) {
        return false;
 ...
 public
  static boolean canPlaceHorizontal(char[][] arr, String word, int r, int c) {
    int i = 0;
    for (; i < word.length(); i++) {
      if (c + i >= arr.length) {
        return false;
 ...
 public
  static void placeVertical(char[][] arr, String word, int r, int c,
                            boolean[] visited) {
 ...
 public
  static void unplaceVertical(char[][] arr, String word, int r, int c,
                              boolean[] visited) {
    for (int i = 0; i < word.length(); i++) {
      if (visited[i] == true) {
        arr[r + i][c] = '-';
 ...
 public
  static void placeHorizontal(char[][] arr, String word, int r, int c,
                              boolean[] visited) {
    for (int i = 0; i < word.length(); i++) {
      if (arr[r][c + i] == '-') {
        visited[i] = true;
 ...
 public
  static void unplaceHorizontal(char[][] arr, String word, int r, int c,
                                boolean[] visited) {
    for (int i = 0; i < word.length(); i++) {
      if (visited[i] == true) {
        arr[r][c + i] = '-';
